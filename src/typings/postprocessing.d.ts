declare module 'postprocessing' {
     ...
     * @property CONVOLUTION - Describes effects that fetch additional samples from the input buffer.
    ...
    export class EdgeDetectionMaterial {
        constructor(texelSize?: Vector2, mode?: typeof EdgeDetectionMode)
        /**
       * The current depth packing.
       */
        depthPacking: number;
         ...
         */
        setEdgeDetectionMode(mode: typeof EdgeDetectionMode): void
        /**
    ...
    export class MaskMaterial {
       ...
       */
         ...
         */
        colorChannel: typeof ColorChannel;
        /**
         * Sets the masking technique.

        The default function is `DISCARD`.
         */
        maskFunction: typeof MaskFunction;
    ...
    export class Effect implements Initializable, Resizable, Disposable {
        constructor(
            ...
            options?: {
                attributes?: typeof EffectAttribute;
                blendFunction?: BlendFunction;
                defines?: Map<string, string>;
                uniforms?: Map<string, Uniform>;
                extensions?: Set<typeof WebGLExtension>;
                vertexShader?: string;
            }
        )
    ...
    export class SMAAEffect extends Effect {
        constructor(searchImage: HTMLImageElement, areaImage: HTMLImageElement, preset?: typeof SMAAPreset, edgeDetectionMode?: typeof EdgeDetectionMode)
        /**
       ...
       */
        applyPreset(preset: typeof SMAAPreset): void
        /**
       * Sets the depth texture.
       * @param depthTexture - A depth texture.
       * @param [depthPacking = 0] - The depth packing.
    ...
    export class LookupTexture3D extends DataTexture3D {
       ...
       */
        scaleUp(size: number, transferData?: boolean): Promise<LookupTexture3D>
